...
load(here::here("docs", "tabs", "post_ts.rdata"))
...
ggsave(g_ppv, filename = here::here("docs", "figs", "g_ts_post_ppv.png"), width = 6, height = 4)
ggsave(g_dur, filename = here::here("docs", "figs", "g_ts_post_dur.png"), width = 6, height = 4)
ggsave(g_post, filename = here::here("docs", "figs", "g_ts_post.png"), width = 9, height = 6)
ggsave(g_cross, filename = here::here("docs", "figs", "g_ts_post_cross.png"), width = 9, height = 6)
ggsave(g_attload, filename = here::here("docs", "figs", "g_ts_post_case.png"), width = 9, height = 6)
ggsave(g_bind_under, filename = here::here("docs", "figs", "g_ts_post_under.png"), width = 9, height = 6)
